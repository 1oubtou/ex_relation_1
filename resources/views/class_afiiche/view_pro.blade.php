		...
		@else
			<table class="table table-row-dashed mx-auto w-50">
				...
				<tbody class="fw-semibold text-gray-600 text-center">
					@foreach ( $prof as $key => $pro )
						<tr>
							<td>
								<a href="#" class="text-gray-800 text-hover-primary fw-bold">{{ ++$key }}</a>
							</td>
							<td>
								<a href="#" class="text-gray-800 text-hover-primary fs-5 fw-bold">{{ $pro->nom }}</a>
							</td>
							<td>
								<a href="#" class="text-gray-800 text-hover-primary fs-5 fw-bold">{{ $pro->prenom }}</a>
							</td>
						</tr>
					@endforeach
				</tbody>
